...
<body>
    <div class="nav" id="navbarpage">
        ...
        <div class="nav-header">
            ...
            <div class="logo">
                <img src="../img/icon.png" style="height: 45px; position:absolute; top:2px; left:640px; ">
            </div>
   ...
   <?php require 'dashboard2index.php'; ?>
   
<?php require 'dashboard2data.php'; ?>

<div class="container">
    <div class="col">
        <h5 style="text-align: center; margin: 1rem 0rem 0rem 18rem; font-weight:600; display: flex;">Showing Result</h5>
    </div>
    <div class="col">
        <button style="text-align: center; justify-content: center; display: flex; margin: -23px 28rem;">Load more</button>
    </div>
</div>
    <script>
        function openNav() {
